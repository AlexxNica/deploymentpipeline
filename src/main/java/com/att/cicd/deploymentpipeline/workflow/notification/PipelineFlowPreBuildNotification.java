...
public class PipelineFlowPreBuildNotification implements JavaDelegate {
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		ApplicationLogger.callLog(gotsid, name, pipelineId, pipelineName, submoduleName, processName,
				"PipelineFlowPreBuildNotification", "execute", "Start");
		if (enabled.equals("1") && !environmentType.equals("PROD") && !gotsid.contains("PROD")) {
		...
		ApplicationLogger.callLog(gotsid, name, pipelineId, pipelineName, submoduleName, processName,
				"PipelineFlowPreBuildNotification", "execute", "End");
	}
